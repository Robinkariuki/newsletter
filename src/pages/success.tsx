...
<div className="max-w-fit  mt-20 md:mt-60 p-8 md:max-w-lg md:bg-white md:border md:border-gray-200 md:rounded-3xl md:shadow dark:bg-gray-800 dark:border-gray-700">
    {/* <a href="#">
    ...
    <div className="mt-10">
        ...
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">A confirmation email has been sent to <b>ash@loremcompany.com.</b> Please open it and click the button inside to confirm your subscription</p>
